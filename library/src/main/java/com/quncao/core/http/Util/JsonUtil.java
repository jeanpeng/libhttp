package com.quncao.core.http.Util;
...
public class JsonUtil {
    ...
    public static JSONObject beanToJsonObject(Object o) throws Exception {
     ...
     * 将list转换成JSONArray
     */
    public static JSONArray beanToJsonArray(List list) throws Exception {
